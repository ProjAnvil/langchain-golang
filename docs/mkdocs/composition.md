...
**Languages:** English | [简体中文](zh-CN/composition.zh-CN.md)
...
equivalent lives in [`core/runnables`](https://github.com/ProjAnvil/langchain-golang/tree/main/core/runnables) and uses free
functions instead:
